...
def main():
    ...
    if power_supply.check_connection():
        ...
        power_supply.configure_voltage_current(0, current_limit)
        print("sleep 30 seconds")
        time.sleep(30)
        print("setting power supply voltage to 5")
        power_supply.configure_voltage_current(5, current_limit)
        print("sleep 30 seconds")
        time.sleep(30)
        print("turining power supply off")
