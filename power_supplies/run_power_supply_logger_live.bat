...
REM Usage: run_power_supply_logger_live.bat [config_file] [output_directory] [sample_interval_ms]
...
cd /d "%~dp0"
python power_supply_continuous_logger_live.py %CONFIG% %OUTPUT_DIR% %SAMPLE_INTERVAL%
